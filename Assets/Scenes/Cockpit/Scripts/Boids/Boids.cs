...
public class Boids : MonoBehaviour
{
    ...
    public static Boids Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = FindAnyObjectByType<Boids>();
            }
            return _instance;
        }
        //set => _instance = value;
    ...
    [System.NonSerialized] public ParticleSystem.EmitParams explosionSystem_ep;
    public ParticleSystem laserSystem;
    [System.NonSerialized] public ParticleSystem.EmitParams laserSystem_ep;
